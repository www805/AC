...
function getactionid_manage() {
    return {
        ...
        //授权统计
        getServerBaseStatistics:"/statistics/getServerBaseStatistics",
        getUsernamePaihb:"/statistics/getUsernamePaihb",
        getElesStatistics:"/statistics/getElesStatistics",
        getYearStatistics:"/statistics/getYearStatistics",
