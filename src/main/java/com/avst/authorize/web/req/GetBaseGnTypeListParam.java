...
public class GetBaseGnTypeListParam extends Page {

    @NotBlank(message = "功能类型名称不能为空", groups = {Create.class, Update.class})
    private String typename;//类型名称
    @NotBlank(message = "功能类型代码不能为空", groups = {Create.class, Update.class})
